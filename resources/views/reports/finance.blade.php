...
<div class="card" style="padding: 24px; background: #f8fafc;">
    ...
    <div class="page-header-row" style="display:flex; justify-content:space-between; align-items:center; padding-bottom:20px; border-bottom:2.5px solid #cbd5e1; margin-bottom:20px;">
        <div style="display:flex; align-items:center; gap:16px;">
            ...
            <div>
                <h2 style="font-size:20px; font-weight:800; color:#0f172a; margin:0 0 4px; letter-spacing:-.5px;text-transform: uppercase">Biểu đồ tài chính</h2>
                <p style="margin:0; color:#64748b; font-size:13px;text-transform: uppercase">Tổng quan doanh thu, lợi nhuận và xu hướng kinh doanh</p>
            </div>
        </div>
    </div>
