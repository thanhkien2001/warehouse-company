...
<head>
    ...
    <style>
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .logo-icon{width:60px;height:60px;background:linear-gradient(135deg,#10568f,#7c3aed);border-radius:16px;display:inline-flex;align-items:center;justify-content:center;font-size:26px;color:#fff;box-shadow:0 10px 25px rgba(79,70,229,.5);margin-bottom:12px;}
        ...
        .form-input:focus{border-color:#10568f;background:rgba(255,255,255,.12);}
        .error-msg{color:#fca5a5;font-size:12.5px;margin-top:5px;}
        .btn-submit{width:100%;padding:14px;background:linear-gradient(135deg,#10568f,#7c3aed);color:#fff;border:none;border-radius:12px;font-size:15px;font-weight:700;font-family:'Inter',sans-serif;cursor:pointer;transition:all .2s;box-shadow:0 8px 24px rgba(79,70,229,.4);}
